...
public class Server {
	...
	public String getInput(Socket client, String userInput) throws IOException {
	...
	public void DebugInputCheck(String userInput, Message clientReturn) {
		System.out
	...
	public void output(Socket client, Message clientReturn) throws IOException {
